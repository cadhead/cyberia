import { initializeChat, sendUserMessage, lastMessages, sendServerMessage } from './chat';
...
export default {
  'user:join_room': ({ socket, room }) => {
    ...
    if (!user) {
      sendServerMessage({ socket, message: { text: 'You have successfully connected. But you can\'t write here. Login first.' } });
